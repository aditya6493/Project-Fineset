  ...
  admin: {
    ...
    stores: {
      ...
      modal: {
        ...
        pocNameLabel: "Store POC",
        pocNamePlaceholder: "Point of contact name",
        pointOfContactPhoneLabel: "Store POC number",
        pointOfContactPhonePlaceholder: "10-digit mobile number",
